    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "ddigson@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Diego",
                LastName = "Admin"
            }; // no DBInitializer a senha precisa ter uma letra maiuscula, um caractere especial e  numero
            _user.CreateAsync(admin,"Diego123$").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Diego123$").GetAwaiter().GetResult();
